...
experiment=SAC_Auto_FiberCupTrainExp2_dynamic_stepsize_RewardNorm
id=$(date +"%F-%H_%M_%S")0
...
policy=${base_dir}/experiments/SAC_Auto_FiberCupTrainExp2_dynamic_stepsize_RewardNorm/2023-11-06-18_14_15/2222/model
...
${hyperparams} --scoring_data ${scoring_data} --npv=300 --dynamic_stepsize
